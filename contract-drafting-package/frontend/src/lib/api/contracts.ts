...
export async function getContractWorkflow(id: number): Promise<any> {
  return get<any>(`/api/contracts/${id}/workflow`);
}

export async function getContractReports(id: number): Promise<any> {
  return get<any>(`/api/contracts/${id}/reports`);
}
